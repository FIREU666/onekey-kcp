...
export SS_LIBEV_YUM_INIT="https://raw.githubusercontent.com/FIREU666/onekey-kcp/master/ss_libev.init"
export SS_LIBEV_APT_INIT="https://raw.githubusercontent.com/FIREU666/onekey-kcp/master/ss_libev_apt.init"
# SSR
export SSR_VER=3.1.1
export SSR_LINK="https://github.com/shadowsocksr/shadowsocksr/archive/manyuser.zip"
export SSR_YUM_INIT="https://raw.githubusercontent.com/FIREU666/onekey-kcp/master/ssr.init"
export SSR_APT_INIT="https://raw.githubusercontent.com/FIREU666/onekey-kcp/master/ssr_apt.init"
# KCPTUN
...
export KCPTUN_INIT="https://raw.githubusercontent.com/FIREU666/onekey-kcp/master/kcptun.init"
